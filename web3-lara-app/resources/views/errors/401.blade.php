        ...
        <div class="max-w-lg w-full">
            <div class="neo-brutalism bg-white p-8 md:p-12 rotate-[1deg]">
                <div class="flex flex-col items-center text-center">
                    <div class="neo-brutalism-sm bg-brutal-green p-6 rotate-[-2deg] mb-6">
                        <span class="text-8xl font-bold">401</span>
                    </div>

                    <h1 class="text-3xl font-bold mb-4">Perlu Autentikasi</h1>
