...
<head>
    ...
    <title>404 - Halaman Tidak Ditemukan | Crypto Recommender</title>
        ...
        <div class="max-w-lg w-full">
            <div class="neo-brutalism bg-white p-8 md:p-12 rotate-[1deg]">
                <div class="flex flex-col items-center text-center">
                    <div class="neo-brutalism-sm bg-brutal-pink p-6 rotate-[-3deg] mb-6">
                        <span class="text-8xl font-bold">404</span>
                    </div>
