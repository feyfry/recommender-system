...
<body class="min-h-screen">
                ...
                <div class="flex items-center space-x-4 mt-4 sm:mt-0">
                    @auth
                        ...
                        <div class="relative" x-data="{ dropdownOpen: false }">
                            ...
                            <div x-show="dropdownOpen" @click.away="dropdownOpen = false" class="clay-dropdown-menu mt-2 py-1" x-transition>
    ...
    <div class="flex-1 relative flex" x-data="{ sidebarOpen: false }">
        <!-- Sidebar -->
        @auth
