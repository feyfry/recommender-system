    ...
    public function projectDetail($projectId)
    {
        ...
        if (!$project) {
            try {
                ...
                $project->price_change_percentage_24h = $projectData['price_change_percentage_24h'] ?? 0;
                $project->price_change_percentage_7d_in_currency = $projectData['price_change_percentage_7d_in_currency'] ?? 0;
