...
Route::prefix('panel')->middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->middleware('role:admin')->group(function () {
        ...
        // NEW: Production Pipeline Routes
        Route::post('/production-pipeline', [AdminController::class, 'runProductionPipeline'])->name('admin.run-production-pipeline');
        Route::get('/production-pipeline/status', [AdminController::class, 'checkProductionPipelineStatus'])->name('admin.production-pipeline.status');
